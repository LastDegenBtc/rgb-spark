 ...
 */
// sprk.11c: ensureLeafOfExactSize + SPARK_DUST_THRESHOLD removed.
// The self-transfer-to-self path that was supposed to coerce an
// exact-sized leaf turned out not to reliably trigger the SE swap
// (mainnet 2026-05-13). Callers now pick the smallest covering or
// smallest available leaf and accept the consequent overpay/handover
// until we redesign with power-of-2-quantized pricing or a multi-leaf
// HTLC. See [[reference-spark-leaf-denominations]] in agent memory.
